...
<body>
<%@page import="com.bean.UserDao,com.bean.*,java.util.*"%>  
...
<th>EmailId</th><th>Password</th><th>Edit</th><th>Delete</th></tr>  
...
<td><a href="StudentDelete.jsp?ID=${u.getID()}">Delete</a></td></tr>  
</c:forEach>  
</table>  
</body>
</html>